 ...
 * on 2018/9/21.
 * 可带边框的圆形ImageView
 * 本文来自 FynnJason 的CSDN 博客 ，全文地址请点击：
 * https://blog.csdn.net/JavaAndroid730/article/details/53143649?utm_source=copy
 */
...
public class RoundImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    public RoundImageView(Context context, AttributeSet attrs) {
        ...
        mBorderWidth = ta.getDimensionPixelSize(R.styleable.RoundImageView_borderWidth, dip2px(DEFAULT_BORDER_WIDTH));
        ta.recycle();
    }
