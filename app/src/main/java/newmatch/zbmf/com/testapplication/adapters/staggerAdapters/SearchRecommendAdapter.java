package newmatch.zbmf.com.testapplication.adapters.staggerAdapters;
 ...
 * on 2019/7/27
 */
public class SearchRecommendAdapter extends RecyclerView.Adapter<SearchRecommendAdapter.Holder> {
    ...
    public int getItemViewType(int position) {
        ...
        int n = position & 1;
        if ((res == 0 && n == 0)) {
            return SearchRecommendAdapter.ITEM_TYPE.BIG_LEFT.ordinal();
        } else if ((res == 1 && n == 0)) {
            return SearchRecommendAdapter.ITEM_TYPE.BIG_RIGHT.ordinal();
        } else if ((res == 1 && n == 1) || (res == 2 && n == 0)) {
            return SearchRecommendAdapter.ITEM_TYPE.SMALL_RIGHT.ordinal();
        } else if ((res == 0 && n == 1) || (res == 2 && n == 1)) {
            return SearchRecommendAdapter.ITEM_TYPE.SMALL_LEFT.ordinal();
        } else {
            return SearchRecommendAdapter.ITEM_TYPE.ALONE_BIG.ordinal();
        }
    }

    @NonNull
    @Override
    public SearchRecommendAdapter.Holder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        if (i == SearchRecommendAdapter.ITEM_TYPE.BIG_LEFT.ordinal()) {
            View view = LayoutInflater.from(viewGroup.getContext())
                    .inflate(R.layout.holder_item_view, viewGroup, false);
            RecyclerView.LayoutParams lp = new RecyclerView.LayoutParams((w - 60) * 2 / 3,
                    (w - 60) * 2 / 3);
            lp.bottomMargin = 10;
            lp.topMargin = 10;
            lp.rightMargin = 20;
            ...
            view.setX(0);
            return new SearchRecommendAdapter.Holder(view);
        } else if (i == SearchRecommendAdapter.ITEM_TYPE.BIG_RIGHT.ordinal()) {
            View view = LayoutInflater.from(viewGroup.getContext())
            ...
            view.setX(-w / 6);
            return new SearchRecommendAdapter.Holder(view);
        } else if (i == SearchRecommendAdapter.ITEM_TYPE.SMALL_LEFT.ordinal()) {
            View view = LayoutInflater.from(viewGroup.getContext())
                    .inflate(R.layout.holder_item_view, viewGroup, false);
            RecyclerView.LayoutParams lp = new RecyclerView.LayoutParams((w - 60) / 3,
                    (w - 60) / 3);
            lp.bottomMargin = 10;
            lp.topMargin = 10;
            lp.rightMargin = 20;
            ...
            view.setX(0);
            return new SearchRecommendAdapter.Holder(view);
        } else if (i == SearchRecommendAdapter.ITEM_TYPE.SMALL_RIGHT.ordinal()) {
            View view = LayoutInflater.from(viewGroup.getContext())
                    .inflate(R.layout.holder_item_view1, viewGroup, false);
            RecyclerView.LayoutParams lp = new RecyclerView.LayoutParams((w - 60) / 3,
                    (w - 60) / 3);
            ...
            view.setX(w / 6);
            return new SearchRecommendAdapter.Holder(view);
        } else if (i == SearchRecommendAdapter.ITEM_TYPE.ALONE_BIG.ordinal()) {
            View view = LayoutInflater.from(viewGroup.getContext())
    ...
    @Override
    public void onBindViewHolder(@NonNull SearchRecommendAdapter.Holder holder, int i) {
