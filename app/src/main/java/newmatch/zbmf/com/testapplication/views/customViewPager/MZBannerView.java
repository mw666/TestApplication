...
public class MZBannerView<T> extends RelativeLayout {
    ...
    private void readAttrs(Context context, AttributeSet attrs) {
        ...
        mGallery = typedArray.getBoolean(R.styleable.MZBannerView_gallery, false);
        typedArray.recycle();
    }
    ...
    private void init() {
        ...
        if (mIsOpenMZEffect) {
            ...
            if (mGallery) {
                view = LayoutInflater.from(getContext()).inflate(R.layout.mz_banner_gallery_layout, this, true);
            } else {
    ...
    private void setOpenMZEffect() {
        ...
        if (mIsOpenMZEffect) {
            if (mIsMiddlePageCover) {
                ...
                // 中间页面不覆盖，页面并排，只是Y轴缩小
                mViewPager.setPageTransformer(false, new ScalerYTransformer());
            }
