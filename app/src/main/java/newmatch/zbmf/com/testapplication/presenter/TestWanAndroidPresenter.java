...
public class TestWanAndroidPresenter implements YeHiPresenter {

    private YeHiView<BannerService,TestWanAndroidPresenter> mBaseView;
     ...
     * @param view
     */
    public TestWanAndroidPresenter(YeHiView<BannerService,TestWanAndroidPresenter> view) {
        this.mBaseView = view;
