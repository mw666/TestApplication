...
public class MZBannerView<T> extends RelativeLayout {
    ...
    private final int mDelayedTime = 3000;// Banner 切换时间间隔
    ...
    //mIndicatorRes[0] 为为选中，mIndicatorRes[1]为选中 原点指示器
    ...
    public void setBannerClickListener(BannerPageClickListener bannerListener){
        this.mBannerPageClickListener=bannerListener;
    }
    ...
    public MZBannerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        readAttrs(context,attrs);
        init();
    }

    public MZBannerView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public MZBannerView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void readAttrs(Context context, AttributeSet attrs){
        ...
        mIsShowIndicator = typedArray.getBoolean(R.styleable.MZBannerView_isShowIndicator, false);
        typedArray.recycle();
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()){
            ...
            case MotionEvent.ACTION_DOWN:
                int paddingLeft = 120/*mViewPager.getLeft()*/;
    ...
    /**
     * 开始轮播
     * <p>应该确保在调用用了{@link MZBannerView {@link (List, List,MZHolderCreator)}} 之后调用这个方法开始轮播</p>
     */
    public void start(){
...
//    }
    ...
    public void setPages(List datas, /*List<T> texts,*/ com.zhouwei.mzbanner.holder.MZHolderCreator<TestBannerViewHolder> mzHolderCreator){
        ...
        mAdapter = new MZPagerAdapter(datas,/*texts,*/mzHolderCreator,mIsCanLoop);
...
//    }
    ...
    public static class  MZPagerAdapter<T> extends PagerAdapter {
        ...
        public MZPagerAdapter(List<T> datas, /*List<T> texts,*/ MZHolderCreator MZHolderCreator, boolean canLoop) {
            if(mDatas == null||mTexts == null){
...
//            mTexts.addAll(texts);
        ...
        public void setDatas(List<T> datas/*, List<T> texts*/) {
            mDatas = datas;
        }
        ...
        private View getView(int position, ViewGroup container){
            ...
            // create holder
            holder = mMZHolderCreator.createViewHolder(position);
            ...
            if( mDatas!=null && mDatas.size()>0){
                holder.onBind(container.getContext(),realPosition,mDatas.get(realPosition)/*,mTexts.get(realPosition)*/);
            }
            // 添加点击事件
     ...
     */
    public static final int mDuration = 600;
