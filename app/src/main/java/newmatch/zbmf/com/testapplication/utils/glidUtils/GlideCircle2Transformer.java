 ...
 */
public class GlideCircle2Transformer implements Transformation<Bitmap> {
    ...
    public GlideCircle2Transformer(Context context) {
        this(Glide.get(context).getBitmapPool());
    }

    public GlideCircle2Transformer(Context context, int coverColor) {
        this(Glide.get(context).getBitmapPool());
        this.coverColor = coverColor;
    }

    public GlideCircle2Transformer(Context context, int coverColor, float radius) {
        this(Glide.get(context).getBitmapPool());
        this.radius = radius;
        this.coverColor = coverColor;
    }

    public GlideCircle2Transformer(BitmapPool pool) {
        this.radius = 0.0F;
