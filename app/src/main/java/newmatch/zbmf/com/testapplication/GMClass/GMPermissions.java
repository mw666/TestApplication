...
import newmatch.zbmf.com.testapplication.activitys.PermissionsActivity;
...
public class GMPermissions {
    ...
    public static void skipPermissionActivity(Activity activity, String[] permission,
                                              Integer requestPermissionCode,String dialogTip) {
        Intent intent = new Intent(activity, PermissionsActivity.class);
        intent.putExtra("Permissions", permission);
        intent.putExtra("requestCode",requestPermissionCode);
        intent.putExtra("dialogTip",dialogTip);
